      ...
      required: [
        ...
        function(password) {
          if (password.length < owasp.configs.minLength) {
            return '비밀번호는 ' + owasp.configs.minLength + ' 자 이상입니다.';
          }
        },
        ...
        function(password) {
          if (password.length > owasp.configs.maxLength) {
            return '비밀번호는 ' + owasp.configs.maxLength + ' 자 미만 입니다.';
          }
        },
        ...
        function(password) {
          if (/(.)\1{2,}/.test(password)) {
            return '비밀번호에는 세 개 이상의 반복 문자를 포함될 수 없습니다.';
          }
        },
      ...
      optional: [
        ...
        function(password) {
          if (!/[a-z]/.test(password)) {
            return '비밀번호는 최소한 하나의 소문자를 포함해야합니다.';
          }
        },
        ...
        function(password) {
          if (!/[A-Z]/.test(password)) {
            return '비밀번호는 최소한 하나의 대문자를 포함해야합니다.';
          }
        },
        ...
        function(password) {
          if (!/[0-9]/.test(password)) {
            return '비밀번호는 하나이상의 숫자를 포함해야합니다.';
          }
        },
        ...
        function(password) {
          if (!/[^A-Za-z0-9]/.test(password)) {
            return '비밀번호는 적어도 하나의 특수 문자를 포함해야합니다';
          }
        },
