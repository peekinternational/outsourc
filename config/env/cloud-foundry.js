...
module.exports = {
  ...
  facebook: {
    clientID: getCred('mean-facebook', 'id') || '1903166153247745',
    clientSecret: getCred('mean-facebook', 'secret') || '6197c19e4fb153d51e75a57f85ce3da7',
  ...
  google: {
    clientID: getCred('mean-google', 'id') || '582675142694-5grevkss563bpj0sq6hke7jf2cmltu8j.apps.googleusercontent.com',
    clientSecret: getCred('mean-google', 'secret') || 'iUJKc0SwpOIHK-0xkjc_8B04',
