...
angular.module('projects').config(['$stateProvider',
  function ($stateProvider) {
    ...
    $stateProvider
      ...
      //  //when click on specific project from project list
      // .state('projects.project-for-bid', {
      //   url: '/project-for-bid',
      //   templateUrl: 'modules/projects/client/views/project-bid.client.view.html',
      //   data: {
      //     roles: ['individual', 'company'],
      ...
      // //when button project bid is clicked
      // .state('projects.project-bidding', {
      //   url: '/project-bidding',
      //   templateUrl: 'modules/projects/client/views/project-bidding.client.view.html',
      //   data: {
      //     roles: ['individual', 'company'],
      ...
      // })
       ...
       // //project bidding  
       // .state('projects.project-bid', {
       //   url: '/project-bid',
       //   templateUrl: 'modules/projects/client/views/looking-bidding.client.view.html',
       //   data: {
       //     roles: ['individual', 'company']
       //   }
       // })
